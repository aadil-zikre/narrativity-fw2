...
from dataset_processor.featurize_dataset import GCDCFeaturizer, WSJFeaturizer, MTLFeaturizer, CombinedFeaturizer,AirbnbFeaturizer
...
class ModelWrapper(pl.LightningModule):
    def __init__(self, args):
        ...
        if self.config_args.task == "sentence-ordering":
            ...
            print("SentenceScorer Task Head Set!")
...
def start_training(args):
    ...
    trainer = pl.Trainer( max_epochs=args.epochs, min_epochs=1, gradient_clip_val=args.clip_grad_norm, 
                        devices=args.gpus, callbacks=[checkpoint_callback], strategy="ddp", logger=args.online_logger,
                        precision=precision_val, accelerator="auto")
...
def init_testing(args): 
    ...
    trainer = pl.Trainer(callbacks=callback_list, devices=args.gpus, strategy='ddp',logger=args.online_logger, 
                                precision=precision_val, accelerator="auto")
    ...
    import pickle
    with open(f"/home/azikre/aadil/github/Transformer-Models-for-Text-Coherence-Assessment/dataset_processor/predictions/predictions_2024_03_20.pkl", 'wb') as fp:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--corpus', choices=['wsj', 'gcdc', 'airbnb'], type=str, default='gcdc',
    ...
    if rank_zero_only.rank == 0:
        ...
        elif args.corpus == 'airbnb': 
            featurizer = AirbnbFeaturizer
        else: 
